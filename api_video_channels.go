...
func (r ApiAddVideoChannelRequest) Execute() (*AddVideoChannel200Response, *http.Response, error) {
...
func (a *VideoChannelsAPIService) AddVideoChannelExecute(r ApiAddVideoChannelRequest) (*AddVideoChannel200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddVideoChannel200Response
	)
...
func (r ApiApiV1VideoChannelsChannelHandleAvatarPickPostRequest) Execute() (*ApiV1UsersMeAvatarPickPost200Response, *http.Response, error) {
...
func (a *VideoChannelsAPIService) ApiV1VideoChannelsChannelHandleAvatarPickPostExecute(r ApiApiV1VideoChannelsChannelHandleAvatarPickPostRequest) (*ApiV1UsersMeAvatarPickPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiApiV1VideoChannelsChannelHandleBannerPickPostRequest) Execute() (*ApiV1VideoChannelsChannelHandleBannerPickPost200Response, *http.Response, error) {
...
func (a *VideoChannelsAPIService) ApiV1VideoChannelsChannelHandleBannerPickPostExecute(r ApiApiV1VideoChannelsChannelHandleBannerPickPostRequest) (*ApiV1VideoChannelsChannelHandleBannerPickPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiV1VideoChannelsChannelHandleBannerPickPost200Response
	)
...
func (r ApiApiV1VideoChannelsChannelHandleImportVideosPostRequest) ImportVideosInChannelCreate(importVideosInChannelCreate ImportVideosInChannelCreate) ApiApiV1VideoChannelsChannelHandleImportVideosPostRequest {
...
func (r ApiApiV1VideoChannelsChannelHandleVideoPlaylistsGetRequest) PlaylistType(playlistType VideoPlaylistTypeSet) ApiApiV1VideoChannelsChannelHandleVideoPlaylistsGetRequest {
	r.playlistType = &playlistType
	return r
}

func (r ApiApiV1VideoChannelsChannelHandleVideoPlaylistsGetRequest) Execute() (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
...
func (a *VideoChannelsAPIService) ApiV1VideoChannelsChannelHandleVideoPlaylistsGetExecute(r ApiApiV1VideoChannelsChannelHandleVideoPlaylistsGetRequest) (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
	var (
...
func (r ApiGetVideoChannelRequest) Execute() (*VideoChannel, *http.Response, error) {
...
//
//	@return VideoChannel
func (a *VideoChannelsAPIService) GetVideoChannelExecute(r ApiGetVideoChannelRequest) (*VideoChannel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetVideoChannelFollowersRequest) Execute() (*GetAccountFollowers200Response, *http.Response, error) {
...
func (a *VideoChannelsAPIService) GetVideoChannelFollowersExecute(r ApiGetVideoChannelFollowersRequest) (*GetAccountFollowers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetAccountFollowers200Response
	)
...
func (r ApiGetVideoChannelVideosRequest) CategoryOneOf(categoryOneOf GetAccountVideosCategoryOneOfParameter) ApiGetVideoChannelVideosRequest {
...
// tag(s) of the video
func (r ApiGetVideoChannelVideosRequest) TagsOneOf(tagsOneOf GetAccountVideosTagsOneOfParameter) ApiGetVideoChannelVideosRequest {
	r.tagsOneOf = &tagsOneOf
	return r
}

// tag(s) of the video, where all should be present in the video
func (r ApiGetVideoChannelVideosRequest) TagsAllOf(tagsAllOf GetAccountVideosTagsAllOfParameter) ApiGetVideoChannelVideosRequest {
	r.tagsAllOf = &tagsAllOf
	return r
}

// licence id of the video (see [/videos/licences](#operation/getLicences))
func (r ApiGetVideoChannelVideosRequest) LicenceOneOf(licenceOneOf GetAccountVideosLicenceOneOfParameter) ApiGetVideoChannelVideosRequest {
...
func (r ApiGetVideoChannelVideosRequest) LanguageOneOf(languageOneOf GetAccountVideosLanguageOneOfParameter) ApiGetVideoChannelVideosRequest {
...
func (r ApiGetVideoChannelVideosRequest) AutoTagOneOf(autoTagOneOf GetAccountVideosTagsAllOfParameter) ApiGetVideoChannelVideosRequest {
...
func (r ApiGetVideoChannelVideosRequest) PrivacyOneOf(privacyOneOf VideoPrivacySet) ApiGetVideoChannelVideosRequest {
...
func (r ApiGetVideoChannelVideosRequest) Execute() (*VideoListResponse, *http.Response, error) {
...
func (a *VideoChannelsAPIService) GetVideoChannelVideosExecute(r ApiGetVideoChannelVideosRequest) (*VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetVideoChannelsRequest) Execute() (*VideoChannelList, *http.Response, error) {
...
func (a *VideoChannelsAPIService) GetVideoChannelsExecute(r ApiGetVideoChannelsRequest) (*VideoChannelList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
