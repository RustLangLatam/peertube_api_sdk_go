...
type ApiApiV1ServerBlocklistServersPostRequest struct {
	ctx                                    context.Context
	ApiService                             *ServerBlocksAPIService
	apiV1ServerBlocklistServersPostRequest *ApiV1ServerBlocklistServersPostRequest
}

func (r ApiApiV1ServerBlocklistServersPostRequest) ApiV1ServerBlocklistServersPostRequest(apiV1ServerBlocklistServersPostRequest ApiV1ServerBlocklistServersPostRequest) ApiApiV1ServerBlocklistServersPostRequest {
