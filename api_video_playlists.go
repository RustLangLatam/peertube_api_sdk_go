...
func (r ApiAddPlaylistRequest) Execute() (*AddPlaylist200Response, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) AddPlaylistExecute(r ApiAddPlaylistRequest) (*AddPlaylist200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddPlaylist200Response
	)
...
func (r ApiAddVideoPlaylistVideoRequest) AddVideoPlaylistVideoRequest(addVideoPlaylistVideoRequest AddVideoPlaylistVideoRequest) ApiAddVideoPlaylistVideoRequest {
	r.addVideoPlaylistVideoRequest = &addVideoPlaylistVideoRequest
	return r
}

func (r ApiAddVideoPlaylistVideoRequest) Execute() (*AddVideoPlaylistVideo200Response, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) AddVideoPlaylistVideoExecute(r ApiAddVideoPlaylistVideoRequest) (*AddVideoPlaylistVideo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddVideoPlaylistVideo200Response
	)
...
func (r ApiApiV1UsersMeVideoPlaylistsVideosExistGetRequest) Execute() (*ApiV1UsersMeVideoPlaylistsVideosExistGet200Response, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) ApiV1UsersMeVideoPlaylistsVideosExistGetExecute(r ApiApiV1UsersMeVideoPlaylistsVideosExistGetRequest) (*ApiV1UsersMeVideoPlaylistsVideosExistGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiV1UsersMeVideoPlaylistsVideosExistGet200Response
	)
...
func (r ApiApiV1VideoPlaylistsPlaylistIdGetRequest) Execute() (*VideoPlaylist, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) ApiV1VideoPlaylistsPlaylistIdGetExecute(r ApiApiV1VideoPlaylistsPlaylistIdGetRequest) (*VideoPlaylist, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiApiV1VideoPlaylistsPlaylistIdPutRequest) Privacy(privacy VideoPlaylistPrivacySet) ApiApiV1VideoPlaylistsPlaylistIdPutRequest {
	r.privacy = &privacy
	return r
}
...
func (r ApiGetPlaylistsRequest) PlaylistType(playlistType VideoPlaylistTypeSet) ApiGetPlaylistsRequest {
	r.playlistType = &playlistType
	return r
}

func (r ApiGetPlaylistsRequest) Execute() (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) GetPlaylistsExecute(r ApiGetPlaylistsRequest) (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetVideoPlaylistVideosRequest) Execute() (*VideoListResponse, *http.Response, error) {
...
func (a *VideoPlaylistsAPIService) GetVideoPlaylistVideosExecute(r ApiGetVideoPlaylistVideosRequest) (*VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiPutVideoPlaylistVideoRequest struct {
	...
	playlistId                   int32
	playlistElementId            int32
	putVideoPlaylistVideoRequest *PutVideoPlaylistVideoRequest
}

func (r ApiPutVideoPlaylistVideoRequest) PutVideoPlaylistVideoRequest(putVideoPlaylistVideoRequest PutVideoPlaylistVideoRequest) ApiPutVideoPlaylistVideoRequest {
...
type ApiReorderVideoPlaylistRequest struct {
	...
	ApiService                  *VideoPlaylistsAPIService
	playlistId                  int32
	reorderVideoPlaylistRequest *ReorderVideoPlaylistRequest
}

func (r ApiReorderVideoPlaylistRequest) ReorderVideoPlaylistRequest(reorderVideoPlaylistRequest ReorderVideoPlaylistRequest) ApiReorderVideoPlaylistRequest {
