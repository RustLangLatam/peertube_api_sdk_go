...
func (r ApiApiV1UsersMeAvatarPickPostRequest) Execute() (*models.ApiV1UsersMeAvatarPickPost200Response, *http.Response, error) {
...
func (a *MyUserAPIService) ApiV1UsersMeAvatarPickPostExecute(r ApiApiV1UsersMeAvatarPickPostRequest) (*models.ApiV1UsersMeAvatarPickPost200Response, *http.Response, error) {
	var (
...
func (r ApiApiV1UsersMeVideoQuotaUsedGetRequest) Execute() (*models.ApiV1UsersMeVideoQuotaUsedGet200Response, *http.Response, error) {
...
func (a *MyUserAPIService) ApiV1UsersMeVideoQuotaUsedGetExecute(r ApiApiV1UsersMeVideoQuotaUsedGetRequest) (*models.ApiV1UsersMeVideoQuotaUsedGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.ApiV1UsersMeVideoQuotaUsedGet200Response
	)
...
func (r ApiApiV1UsersMeVideosGetRequest) Execute() (*models.VideoListResponse, *http.Response, error) {
...
func (a *MyUserAPIService) ApiV1UsersMeVideosGetExecute(r ApiApiV1UsersMeVideosGetRequest) (*models.VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiApiV1UsersMeVideosImportsGetRequest) Execute() (*models.VideoImportsList, *http.Response, error) {
...
func (a *MyUserAPIService) ApiV1UsersMeVideosImportsGetExecute(r ApiApiV1UsersMeVideosImportsGetRequest) (*models.VideoImportsList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.VideoImportsList
	)
...
func (r ApiApiV1UsersMeVideosVideoIdRatingGetRequest) Execute() (*models.GetMeVideoRating, *http.Response, error) {
...
func (a *MyUserAPIService) ApiV1UsersMeVideosVideoIdRatingGetExecute(r ApiApiV1UsersMeVideosVideoIdRatingGetRequest) (*models.GetMeVideoRating, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.GetMeVideoRating
	)
	...
	localVarFormParams := url.Values{}
	if r.videoId < 1 {
		return localVarReturnValue, nil, utils.ReportError("videoId must be greater than 1")
	}
...
func (r ApiGetUserInfoRequest) Execute() ([]models.User, *http.Response, error) {
...
//
//	@return []User
func (a *MyUserAPIService) GetUserInfoExecute(r ApiGetUserInfoRequest) ([]models.User, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPutUserInfoRequest) UpdateMe(updateMe models.UpdateMe) ApiPutUserInfoRequest {
	r.updateMe = &updateMe
	return r
}
...
func (a *MyUserAPIService) PutUserInfoExecute(r ApiPutUserInfoRequest) (*http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.updateMe == nil {
		return nil, utils.ReportError("updateMe is required and must be specified")
	}
