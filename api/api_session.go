...
func (r ApiGetOAuthClientRequest) Execute() (*models.OAuthClient, *http.Response, error) {
...
*/
func (a *SessionAPIService) GetOAuthClient(ctx context.Context) ApiGetOAuthClientRequest {
	return ApiGetOAuthClientRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return OAuthClient
func (a *SessionAPIService) GetOAuthClientExecute(r ApiGetOAuthClientRequest) (*models.OAuthClient, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.OAuthClient
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionAPIService.GetOAuthClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/oauth-clients/local"
...
func (r ApiGetOAuthTokenRequest) ClientSecret(clientSecret string) ApiGetOAuthTokenRequest {
...
func (r ApiGetOAuthTokenRequest) Execute() (*models.GetOAuthToken200Response, *http.Response, error) {
...
*/
func (a *SessionAPIService) GetOAuthToken(ctx context.Context) ApiGetOAuthTokenRequest {
	return ApiGetOAuthTokenRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SessionAPIService) GetOAuthTokenExecute(r ApiGetOAuthTokenRequest) (*models.GetOAuthToken200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.GetOAuthToken200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionAPIService.GetOAuthToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/token"
...
*/
func (a *SessionAPIService) RevokeOAuthToken(ctx context.Context) ApiRevokeOAuthTokenRequest {
	return ApiRevokeOAuthTokenRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SessionAPIService) RevokeOAuthTokenExecute(r ApiRevokeOAuthTokenRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionAPIService.RevokeOAuthToken")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/revoke-token"
