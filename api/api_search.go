...
func (r ApiSearchChannelsRequest) Execute() (*models.VideoChannelList, *http.Response, error) {
...
func (a *SearchAPIService) SearchChannelsExecute(r ApiSearchChannelsRequest) (*models.VideoChannelList, *http.Response, error) {
	var (
	...
	if r.search == nil {
		return localVarReturnValue, nil, utils.ReportError("search is required and must be specified")
	}
...
func (r ApiSearchPlaylistsRequest) Execute() (*models.ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
...
func (a *SearchAPIService) SearchPlaylistsExecute(r ApiSearchPlaylistsRequest) (*models.ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiSearchVideosRequest) CategoryOneOf(categoryOneOf models.GetAccountVideosCategoryOneOfParameter) ApiSearchVideosRequest {
...
// tag(s) of the video
func (r ApiSearchVideosRequest) TagsOneOf(tagsOneOf models.GetAccountVideosTagsOneOfParameter) ApiSearchVideosRequest {
	r.tagsOneOf = &tagsOneOf
	return r
}

// tag(s) of the video, where all should be present in the video
func (r ApiSearchVideosRequest) TagsAllOf(tagsAllOf models.GetAccountVideosTagsAllOfParameter) ApiSearchVideosRequest {
	r.tagsAllOf = &tagsAllOf
	return r
}

// licence id of the video (see [/videos/licences](#operation/getLicences))
func (r ApiSearchVideosRequest) LicenceOneOf(licenceOneOf models.GetAccountVideosLicenceOneOfParameter) ApiSearchVideosRequest {
...
func (r ApiSearchVideosRequest) LanguageOneOf(languageOneOf models.GetAccountVideosLanguageOneOfParameter) ApiSearchVideosRequest {
...
func (r ApiSearchVideosRequest) AutoTagOneOf(autoTagOneOf models.GetAccountVideosTagsAllOfParameter) ApiSearchVideosRequest {
...
func (r ApiSearchVideosRequest) PrivacyOneOf(privacyOneOf models.VideoPrivacySet) ApiSearchVideosRequest {
...
func (r ApiSearchVideosRequest) Execute() (*models.VideoListResponse, *http.Response, error) {
...
func (a *SearchAPIService) SearchVideosExecute(r ApiSearchVideosRequest) (*models.VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
