...
*/
func (a *VideoRatesAPIService) ApiV1VideosIdRatePut(ctx context.Context, id models.ApiV1VideosOwnershipIdAcceptPostIdParameter) ApiApiV1VideosIdRatePutRequest {
	return ApiApiV1VideosIdRatePutRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
