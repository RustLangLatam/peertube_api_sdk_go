...
func (r ApiGetSyndicatedCommentsRequest) Execute() ([]models.VideoCommentsForXMLInner, *http.Response, error) {
...
func (a *VideoFeedsAPIService) GetSyndicatedCommentsExecute(r ApiGetSyndicatedCommentsRequest) ([]models.VideoCommentsForXMLInner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []models.VideoCommentsForXMLInner
	)
...
func (r ApiGetSyndicatedSubscriptionVideosRequest) PrivacyOneOf(privacyOneOf models.VideoPrivacySet) ApiGetSyndicatedSubscriptionVideosRequest {
...
func (r ApiGetSyndicatedSubscriptionVideosRequest) Execute() ([]models.VideosForXMLInner, *http.Response, error) {
...
func (a *VideoFeedsAPIService) GetSyndicatedSubscriptionVideosExecute(r ApiGetSyndicatedSubscriptionVideosRequest) ([]models.VideosForXMLInner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []models.VideosForXMLInner
	)
	...
	localVarFormParams := url.Values{}
	if r.accountId == nil {
		return localVarReturnValue, nil, utils.ReportError("accountId is required and must be specified")
	}
	if r.token == nil {
		return localVarReturnValue, nil, utils.ReportError("token is required and must be specified")
	}
...
// **PeerTube &gt;&#x3D; 4.0** Display only videos in this specific privacy/privacies
func (r ApiGetSyndicatedVideosRequest) PrivacyOneOf(privacyOneOf models.VideoPrivacySet) ApiGetSyndicatedVideosRequest {
	r.privacyOneOf = &privacyOneOf
	return r
}
...
func (r ApiGetSyndicatedVideosRequest) Execute() ([]models.VideosForXMLInner, *http.Response, error) {
...
//
//	@return []VideosForXMLInner
func (a *VideoFeedsAPIService) GetSyndicatedVideosExecute(r ApiGetSyndicatedVideosRequest) ([]models.VideosForXMLInner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *VideoFeedsAPIService) GetVideosPodcastFeedExecute(r ApiGetVideosPodcastFeedRequest) (*http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.videoChannelId == nil {
		return nil, utils.ReportError("videoChannelId is required and must be specified")
	}
