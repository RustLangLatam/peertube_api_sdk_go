...
type ApiAcceptRegistrationRequest struct {
	...
	userRegistrationAcceptOrReject *models.UserRegistrationAcceptOrReject
}

func (r ApiAcceptRegistrationRequest) UserRegistrationAcceptOrReject(userRegistrationAcceptOrReject models.UserRegistrationAcceptOrReject) ApiAcceptRegistrationRequest {
...
func (a *RegisterAPIService) AcceptRegistrationExecute(r ApiAcceptRegistrationRequest) (*http.Response, error) {
	...
	if r.registrationId < 1 {
		return nil, utils.ReportError("registrationId must be greater than 1")
	}
...
func (r ApiListRegistrationsRequest) Execute() (*models.ListRegistrations200Response, *http.Response, error) {
...
func (a *RegisterAPIService) ListRegistrationsExecute(r ApiListRegistrationsRequest) (*models.ListRegistrations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.ListRegistrations200Response
	)
...
func (r ApiRegisterUserRequest) RegisterUser(registerUser models.RegisterUser) ApiRegisterUserRequest {
...
func (a *RegisterAPIService) RegisterUserExecute(r ApiRegisterUserRequest) (*http.Response, error) {
	...
	if r.registerUser == nil {
		return nil, utils.ReportError("registerUser is required and must be specified")
	}
...
func (r ApiRejectRegistrationRequest) UserRegistrationAcceptOrReject(userRegistrationAcceptOrReject models.UserRegistrationAcceptOrReject) ApiRejectRegistrationRequest {
	r.userRegistrationAcceptOrReject = &userRegistrationAcceptOrReject
	return r
}
...
type ApiRequestRegistrationRequest struct {
	ctx                     context.Context
	ApiService              *RegisterAPIService
	userRegistrationRequest *models.UserRegistrationRequest
}

func (r ApiRequestRegistrationRequest) UserRegistrationRequest(userRegistrationRequest models.UserRegistrationRequest) ApiRequestRegistrationRequest {
	r.userRegistrationRequest = &userRegistrationRequest
	return r
}

func (r ApiRequestRegistrationRequest) Execute() (*models.UserRegistration, *http.Response, error) {
...
func (a *RegisterAPIService) RequestRegistrationExecute(r ApiRequestRegistrationRequest) (*models.UserRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.UserRegistration
	)
...
type ApiResendEmailToVerifyRegistrationRequest struct {
	ctx                                    context.Context
	ApiService                             *RegisterAPIService
	resendEmailToVerifyRegistrationRequest *models.ResendEmailToVerifyRegistrationRequest
}

func (r ApiResendEmailToVerifyRegistrationRequest) ResendEmailToVerifyRegistrationRequest(resendEmailToVerifyRegistrationRequest models.ResendEmailToVerifyRegistrationRequest) ApiResendEmailToVerifyRegistrationRequest {
...
type ApiVerifyRegistrationEmailRequest struct {
	...
	ApiService                     *RegisterAPIService
	registrationId                 int32
	verifyRegistrationEmailRequest *models.VerifyRegistrationEmailRequest
}

func (r ApiVerifyRegistrationEmailRequest) VerifyRegistrationEmailRequest(verifyRegistrationEmailRequest models.VerifyRegistrationEmailRequest) ApiVerifyRegistrationEmailRequest {
