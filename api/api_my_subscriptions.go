...
func (a *MySubscriptionsAPIService) ApiV1UsersMeSubscriptionsExistGetExecute(r ApiApiV1UsersMeSubscriptionsExistGetRequest) (map[string]interface{}, *http.Response, error) {
	...
	if r.uris == nil {
		return localVarReturnValue, nil, utils.ReportError("uris is required and must be specified")
	}
...
func (r ApiApiV1UsersMeSubscriptionsGetRequest) Execute() (*models.VideoChannelList, *http.Response, error) {
...
func (a *MySubscriptionsAPIService) ApiV1UsersMeSubscriptionsGetExecute(r ApiApiV1UsersMeSubscriptionsGetRequest) (*models.VideoChannelList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiApiV1UsersMeSubscriptionsPostRequest struct {
	ctx                                  context.Context
	ApiService                           *MySubscriptionsAPIService
	apiV1UsersMeSubscriptionsPostRequest *models.ApiV1UsersMeSubscriptionsPostRequest
}

func (r ApiApiV1UsersMeSubscriptionsPostRequest) ApiV1UsersMeSubscriptionsPostRequest(apiV1UsersMeSubscriptionsPostRequest models.ApiV1UsersMeSubscriptionsPostRequest) ApiApiV1UsersMeSubscriptionsPostRequest {
...
func (r ApiApiV1UsersMeSubscriptionsSubscriptionHandleGetRequest) Execute() (*models.VideoChannel, *http.Response, error) {
...
//
//	@return VideoChannel
func (a *MySubscriptionsAPIService) ApiV1UsersMeSubscriptionsSubscriptionHandleGetExecute(r ApiApiV1UsersMeSubscriptionsSubscriptionHandleGetRequest) (*models.VideoChannel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) CategoryOneOf(categoryOneOf models.GetAccountVideosCategoryOneOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
...
// tag(s) of the video
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) TagsOneOf(tagsOneOf models.GetAccountVideosTagsOneOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
	r.tagsOneOf = &tagsOneOf
	return r
}

// tag(s) of the video, where all should be present in the video
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) TagsAllOf(tagsAllOf models.GetAccountVideosTagsAllOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
	r.tagsAllOf = &tagsAllOf
	return r
}

// licence id of the video (see [/videos/licences](#operation/getLicences))
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) LicenceOneOf(licenceOneOf models.GetAccountVideosLicenceOneOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
...
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) LanguageOneOf(languageOneOf models.GetAccountVideosLanguageOneOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
...
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) AutoTagOneOf(autoTagOneOf models.GetAccountVideosTagsAllOfParameter) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
...
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) PrivacyOneOf(privacyOneOf models.VideoPrivacySet) ApiApiV1UsersMeSubscriptionsVideosGetRequest {
...
func (r ApiApiV1UsersMeSubscriptionsVideosGetRequest) Execute() (*models.VideoListResponse, *http.Response, error) {
...
func (a *MySubscriptionsAPIService) ApiV1UsersMeSubscriptionsVideosGetExecute(r ApiApiV1UsersMeSubscriptionsVideosGetRequest) (*models.VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
