...
type ApiAddLiveRequest struct {
	...
	name            *string
	saveReplay      *bool
	replaySettings  *models.LiveVideoReplaySettings
	permanentLive   *bool
	latencyMode     *models.LiveVideoLatencyMode
...
func (r ApiAddLiveRequest) ReplaySettings(replaySettings models.LiveVideoReplaySettings) ApiAddLiveRequest {
...
func (r ApiAddLiveRequest) LatencyMode(latencyMode models.LiveVideoLatencyMode) ApiAddLiveRequest {
...
func (r ApiAddLiveRequest) Privacy(privacy models.VideoPrivacySet) ApiAddLiveRequest {
	r.privacy = &privacy
	return r
}
...
func (r ApiAddLiveRequest) CommentsPolicy(commentsPolicy models.VideoCommentsPolicySet) ApiAddLiveRequest {
...
func (r ApiAddLiveRequest) Execute() (*models.VideoUploadResponse, *http.Response, error) {
...
func (a *LiveVideosAPIService) AddLiveExecute(r ApiAddLiveRequest) (*models.VideoUploadResponse, *http.Response, error) {
	var (
...
func (r ApiApiV1VideosIdLiveSessionGetRequest) Execute() (*models.LiveVideoSessionResponse, *http.Response, error) {
...
*/
func (a *LiveVideosAPIService) ApiV1VideosIdLiveSessionGet(ctx context.Context, id models.ApiV1VideosOwnershipIdAcceptPostIdParameter) ApiApiV1VideosIdLiveSessionGetRequest {
	return ApiApiV1VideosIdLiveSessionGetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *LiveVideosAPIService) ApiV1VideosIdLiveSessionGetExecute(r ApiApiV1VideosIdLiveSessionGetRequest) (*models.LiveVideoSessionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.LiveVideoSessionResponse
	)
...
func (r ApiApiV1VideosLiveIdSessionsGetRequest) Execute() (*models.ApiV1VideosLiveIdSessionsGet200Response, *http.Response, error) {
...
*/
func (a *LiveVideosAPIService) ApiV1VideosLiveIdSessionsGet(ctx context.Context, id models.ApiV1VideosOwnershipIdAcceptPostIdParameter) ApiApiV1VideosLiveIdSessionsGetRequest {
	return ApiApiV1VideosLiveIdSessionsGetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *LiveVideosAPIService) ApiV1VideosLiveIdSessionsGetExecute(r ApiApiV1VideosLiveIdSessionsGetRequest) (*models.ApiV1VideosLiveIdSessionsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.ApiV1VideosLiveIdSessionsGet200Response
	)
...
func (r ApiGetLiveIdRequest) Execute() (*models.LiveVideoResponse, *http.Response, error) {
...
*/
func (a *LiveVideosAPIService) GetLiveId(ctx context.Context, id models.ApiV1VideosOwnershipIdAcceptPostIdParameter) ApiGetLiveIdRequest {
	return ApiGetLiveIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *LiveVideosAPIService) GetLiveIdExecute(r ApiGetLiveIdRequest) (*models.LiveVideoResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.LiveVideoResponse
	)
...
type ApiUpdateLiveIdRequest struct {
	...
	ApiService      *LiveVideosAPIService
	id              models.ApiV1VideosOwnershipIdAcceptPostIdParameter
	liveVideoUpdate *models.LiveVideoUpdate
}

func (r ApiUpdateLiveIdRequest) LiveVideoUpdate(liveVideoUpdate models.LiveVideoUpdate) ApiUpdateLiveIdRequest {
...
*/
func (a *LiveVideosAPIService) UpdateLiveId(ctx context.Context, id models.ApiV1VideosOwnershipIdAcceptPostIdParameter) ApiUpdateLiveIdRequest {
	return ApiUpdateLiveIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
