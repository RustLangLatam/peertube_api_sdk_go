...
var _ MappedNullable = &VideoStatsOverall{}
...
func (o *VideoStatsOverall) GetAverageWatchTime() float32 {
	if o == nil || IsNil(o.AverageWatchTime) {
		var ret float32
		return ret
	}
...
func (o *VideoStatsOverall) GetTotalWatchTime() float32 {
	if o == nil || IsNil(o.TotalWatchTime) {
		var ret float32
		return ret
	}
...
func (o *VideoStatsOverall) GetViewersPeakDate() time.Time {
	if o == nil || IsNil(o.ViewersPeakDate) {
		var ret time.Time
		return ret
	}
