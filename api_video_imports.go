...
func (r ApiImportVideoRequest) CommentsPolicy(commentsPolicy VideoCommentsPolicySet) ApiImportVideoRequest {
...
func (r ApiImportVideoRequest) Execute() (*VideoUploadResponse, *http.Response, error) {
...
func (a *VideoImportsAPIService) ImportVideoExecute(r ApiImportVideoRequest) (*VideoUploadResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
