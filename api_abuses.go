...
func (r ApiApiV1AbusesAbuseIdMessagesGetRequest) Execute() (*ApiV1AbusesAbuseIdMessagesGet200Response, *http.Response, error) {
...
func (a *AbusesAPIService) ApiV1AbusesAbuseIdMessagesGetExecute(r ApiApiV1AbusesAbuseIdMessagesGetRequest) (*ApiV1AbusesAbuseIdMessagesGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiV1AbusesAbuseIdMessagesGet200Response
	)
...
type ApiApiV1AbusesAbuseIdMessagesPostRequest struct {
	ctx                                   context.Context
	ApiService                            *AbusesAPIService
	apiV1AbusesAbuseIdMessagesPostRequest *ApiV1AbusesAbuseIdMessagesPostRequest
	abuseId                               int32
}

func (r ApiApiV1AbusesAbuseIdMessagesPostRequest) ApiV1AbusesAbuseIdMessagesPostRequest(apiV1AbusesAbuseIdMessagesPostRequest ApiV1AbusesAbuseIdMessagesPostRequest) ApiApiV1AbusesAbuseIdMessagesPostRequest {
...
func (a *AbusesAPIService) ApiV1AbusesAbuseIdMessagesPostExecute(r ApiApiV1AbusesAbuseIdMessagesPostRequest) (*http.Response, error) {
	...
	if r.apiV1AbusesAbuseIdMessagesPostRequest == nil {
		return nil, reportError("apiV1AbusesAbuseIdMessagesPostRequest is required and must be specified")
	}
	if r.abuseId < 1 {
		return nil, reportError("abuseId must be greater than 1")
	}
...
func (r ApiApiV1AbusesAbuseIdPutRequest) ApiV1AbusesAbuseIdPutRequest(apiV1AbusesAbuseIdPutRequest ApiV1AbusesAbuseIdPutRequest) ApiApiV1AbusesAbuseIdPutRequest {
...
type ApiApiV1AbusesPostRequest struct {
	ctx                    context.Context
	ApiService             *AbusesAPIService
	apiV1AbusesPostRequest *ApiV1AbusesPostRequest
}

func (r ApiApiV1AbusesPostRequest) ApiV1AbusesPostRequest(apiV1AbusesPostRequest ApiV1AbusesPostRequest) ApiApiV1AbusesPostRequest {
	r.apiV1AbusesPostRequest = &apiV1AbusesPostRequest
	return r
}

func (r ApiApiV1AbusesPostRequest) Execute() (*ApiV1AbusesPost200Response, *http.Response, error) {
...
func (a *AbusesAPIService) ApiV1AbusesPostExecute(r ApiApiV1AbusesPostRequest) (*ApiV1AbusesPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiV1AbusesPost200Response
	)
	...
	if r.apiV1AbusesPostRequest == nil {
		return localVarReturnValue, nil, reportError("apiV1AbusesPostRequest is required and must be specified")
	}
...
func (r ApiGetAbusesRequest) Execute() (*GetMyAbuses200Response, *http.Response, error) {
...
func (a *AbusesAPIService) GetAbusesExecute(r ApiGetAbusesRequest) (*GetMyAbuses200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetMyAbuses200Response
	)
...
func (r ApiGetMyAbusesRequest) Execute() (*GetMyAbuses200Response, *http.Response, error) {
...
//
//	@return GetMyAbuses200Response
func (a *AbusesAPIService) GetMyAbusesExecute(r ApiGetMyAbusesRequest) (*GetMyAbuses200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
