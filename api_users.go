...
func (r ApiAddUserRequest) AddUser(addUser AddUser) ApiAddUserRequest {
	r.addUser = &addUser
	return r
}

func (r ApiAddUserRequest) Execute() (*AddUserResponse, *http.Response, error) {
...
func (a *UsersAPIService) AddUserExecute(r ApiAddUserRequest) (*AddUserResponse, *http.Response, error) {
	var (
	...
	if r.addUser == nil {
		return localVarReturnValue, nil, reportError("addUser is required and must be specified")
	}
...
type ApiConfirmTwoFactorRequestRequest struct {
	...
	ApiService                     *UsersAPIService
	id                             int32
	confirmTwoFactorRequestRequest *ConfirmTwoFactorRequestRequest
}

func (r ApiConfirmTwoFactorRequestRequest) ConfirmTwoFactorRequestRequest(confirmTwoFactorRequestRequest ConfirmTwoFactorRequestRequest) ApiConfirmTwoFactorRequestRequest {
...
type ApiDisableTwoFactorRequest struct {
	...
	ApiService              *UsersAPIService
	id                      int32
	requestTwoFactorRequest *RequestTwoFactorRequest
}

func (r ApiDisableTwoFactorRequest) RequestTwoFactorRequest(requestTwoFactorRequest RequestTwoFactorRequest) ApiDisableTwoFactorRequest {
...
func (r ApiPutUserRequest) UpdateUser(updateUser UpdateUser) ApiPutUserRequest {
...
func (r ApiRequestTwoFactorRequest) RequestTwoFactorRequest(requestTwoFactorRequest RequestTwoFactorRequest) ApiRequestTwoFactorRequest {
	r.requestTwoFactorRequest = &requestTwoFactorRequest
	return r
}

func (r ApiRequestTwoFactorRequest) Execute() ([]RequestTwoFactorResponse, *http.Response, error) {
...
func (a *UsersAPIService) RequestTwoFactorExecute(r ApiRequestTwoFactorRequest) ([]RequestTwoFactorResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []RequestTwoFactorResponse
	)
...
func (r ApiResendEmailToVerifyUserRequest) ResendEmailToVerifyUserRequest(resendEmailToVerifyUserRequest ResendEmailToVerifyUserRequest) ApiResendEmailToVerifyUserRequest {
...
func (r ApiVerifyUserRequest) VerifyUserRequest(verifyUserRequest VerifyUserRequest) ApiVerifyUserRequest {
