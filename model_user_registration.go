...
type UserRegistration struct {
	...
	ModerationResponse NullableString               `json:"moderationResponse,omitempty"`
...
func (o *UserRegistration) GetModerationResponse() string {
	if o == nil || IsNil(o.ModerationResponse.Get()) {
		var ret string
		return ret
	}
...
func (o *UserRegistration) GetChannelHandle() string {
	if o == nil || IsNil(o.ChannelHandle) {
		var ret string
		return ret
	}
...
func (o *UserRegistration) GetChannelDisplayName() string {
	if o == nil || IsNil(o.ChannelDisplayName) {
		var ret string
		return ret
	}
...
func (o UserRegistration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ChannelHandle) {
		toSerialize["channelHandle"] = o.ChannelHandle
	}
	if !IsNil(o.ChannelDisplayName) {
