...
func (r ApiApiV1ServerFollowersGetRequest) Execute() (*GetAccountFollowers200Response, *http.Response, error) {
...
func (a *InstanceFollowsAPIService) ApiV1ServerFollowersGetExecute(r ApiApiV1ServerFollowersGetRequest) (*GetAccountFollowers200Response, *http.Response, error) {
	var (
...
func (r ApiApiV1ServerFollowingGetRequest) Execute() (*GetAccountFollowers200Response, *http.Response, error) {
...
//
//	@return GetAccountFollowers200Response
func (a *InstanceFollowsAPIService) ApiV1ServerFollowingGetExecute(r ApiApiV1ServerFollowingGetRequest) (*GetAccountFollowers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiApiV1ServerFollowingPostRequest struct {
	ctx                             context.Context
	ApiService                      *InstanceFollowsAPIService
	apiV1ServerFollowingPostRequest *ApiV1ServerFollowingPostRequest
}

func (r ApiApiV1ServerFollowingPostRequest) ApiV1ServerFollowingPostRequest(apiV1ServerFollowingPostRequest ApiV1ServerFollowingPostRequest) ApiApiV1ServerFollowingPostRequest {
