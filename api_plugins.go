...
type ApiApiV1PluginsNpmNameSettingsPutRequest struct {
	...
	ApiService                            *PluginsAPIService
	npmName                               string
	apiV1PluginsNpmNameSettingsPutRequest *ApiV1PluginsNpmNameSettingsPutRequest
}

func (r ApiApiV1PluginsNpmNameSettingsPutRequest) ApiV1PluginsNpmNameSettingsPutRequest(apiV1PluginsNpmNameSettingsPutRequest ApiV1PluginsNpmNameSettingsPutRequest) ApiApiV1PluginsNpmNameSettingsPutRequest {
...
func (r ApiGetAvailablePluginsRequest) Execute() (*PluginResponse, *http.Response, error) {
...
func (a *PluginsAPIService) GetAvailablePluginsExecute(r ApiGetAvailablePluginsRequest) (*PluginResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PluginResponse
	)
...
func (r ApiGetPluginsRequest) Execute() (*PluginResponse, *http.Response, error) {
...
//
//	@return PluginResponse
func (a *PluginsAPIService) GetPluginsExecute(r ApiGetPluginsRequest) (*PluginResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUninstallPluginRequest) UninstallPluginRequest(uninstallPluginRequest UninstallPluginRequest) ApiUninstallPluginRequest {
...
func (r ApiUpdatePluginRequest) AddPluginRequest(addPluginRequest AddPluginRequest) ApiUpdatePluginRequest {
	r.addPluginRequest = &addPluginRequest
	return r
}
