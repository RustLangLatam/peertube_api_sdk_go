...
var _ MappedNullable = &UserWithStats{}
...
func (o *UserWithStats) GetVideoChannels() []VideoChannel {
	if o == nil || IsNil(o.VideoChannels) {
...
func (o *UserWithStats) GetAbusesAcceptedCount() int32 {
	if o == nil || IsNil(o.AbusesAcceptedCount) {
		var ret int32
		return ret
	}
...
func (o *UserWithStats) GetAbusesCreatedCount() int32 {
	if o == nil || IsNil(o.AbusesCreatedCount) {
		var ret int32
		return ret
	}
...
func (o *UserWithStats) GetVideoCommentsCount() int32 {
	if o == nil || IsNil(o.VideoCommentsCount) {
		var ret int32
		return ret
	}
