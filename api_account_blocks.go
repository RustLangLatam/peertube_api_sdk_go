...
func (r ApiApiV1BlocklistStatusGetRequest) Execute() (*BlockStatus, *http.Response, error) {
...
//
//	@return BlockStatus
func (a *AccountBlocksAPIService) ApiV1BlocklistStatusGetExecute(r ApiApiV1BlocklistStatusGetRequest) (*BlockStatus, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *BlockStatus
	)
...
type ApiApiV1ServerBlocklistAccountsPostRequest struct {
	ctx                                     context.Context
	ApiService                              *AccountBlocksAPIService
	apiV1ServerBlocklistAccountsPostRequest *ApiV1ServerBlocklistAccountsPostRequest
}

func (r ApiApiV1ServerBlocklistAccountsPostRequest) ApiV1ServerBlocklistAccountsPostRequest(apiV1ServerBlocklistAccountsPostRequest ApiV1ServerBlocklistAccountsPostRequest) ApiApiV1ServerBlocklistAccountsPostRequest {
