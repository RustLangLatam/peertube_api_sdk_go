...
// checks if the VideosForXMLInnerMediaThumbnail type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideosForXMLInnerMediaThumbnail{}

// VideosForXMLInnerMediaThumbnail struct for VideosForXMLInnerMediaThumbnail
type VideosForXMLInnerMediaThumbnail struct {
...
func NewVideosForXMLInnerMediaThumbnail() *VideosForXMLInnerMediaThumbnail {
	this := VideosForXMLInnerMediaThumbnail{}
	return &this
}
...
func (o VideosForXMLInnerMediaThumbnail) MarshalJSON() ([]byte, error) {
...
func (o VideosForXMLInnerMediaThumbnail) ToMap() (map[string]interface{}, error) {
...
type NullableVideosForXMLInnerMediaThumbnail struct {
	value *VideosForXMLInnerMediaThumbnail
	isSet bool
}

func (v NullableVideosForXMLInnerMediaThumbnail) Get() *VideosForXMLInnerMediaThumbnail {
	return v.value
}

func (v *NullableVideosForXMLInnerMediaThumbnail) Set(val *VideosForXMLInnerMediaThumbnail) {
	v.value = val
	v.isSet = true
}

func (v NullableVideosForXMLInnerMediaThumbnail) IsSet() bool {
	return v.isSet
}

func (v *NullableVideosForXMLInnerMediaThumbnail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideosForXMLInnerMediaThumbnail(val *VideosForXMLInnerMediaThumbnail) *NullableVideosForXMLInnerMediaThumbnail {
	return &NullableVideosForXMLInnerMediaThumbnail{value: val, isSet: true}
}

func (v NullableVideosForXMLInnerMediaThumbnail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideosForXMLInnerMediaThumbnail) UnmarshalJSON(src []byte) error {
	v.isSet = true
