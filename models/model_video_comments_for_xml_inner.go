...
// checks if the VideoCommentsForXMLInner type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoCommentsForXMLInner{}

// VideoCommentsForXMLInner struct for VideoCommentsForXMLInner
type VideoCommentsForXMLInner struct {
...
func (o *VideoCommentsForXMLInner) GetPubDate() time.Time {
	if o == nil || utils.IsNil(o.PubDate) {
		var ret time.Time
		return ret
	}
	return *o.PubDate
...
func (o *VideoCommentsForXMLInner) GetContentEncoded() string {
	if o == nil || utils.IsNil(o.ContentEncoded) {
		var ret string
		return ret
	}
...
func (o *VideoCommentsForXMLInner) GetDcCreator() string {
	if o == nil || utils.IsNil(o.DcCreator) {
		var ret string
		return ret
	}
	return *o.DcCreator
...
func (o VideoCommentsForXMLInner) MarshalJSON() ([]byte, error) {
...
func (o VideoCommentsForXMLInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.Link) {
		toSerialize["link"] = o.Link
	}
	if !utils.IsNil(o.Guid) {
		toSerialize["guid"] = o.Guid
	}
	if !utils.IsNil(o.PubDate) {
		toSerialize["pubDate"] = o.PubDate
	}
	if !utils.IsNil(o.ContentEncoded) {
		toSerialize["content:encoded"] = o.ContentEncoded
	}
	if !utils.IsNil(o.DcCreator) {
		toSerialize["dc:creator"] = o.DcCreator
	}
	return toSerialize, nil
}

type NullableVideoCommentsForXMLInner struct {
	value *VideoCommentsForXMLInner
	isSet bool
}

func (v NullableVideoCommentsForXMLInner) Get() *VideoCommentsForXMLInner {
	return v.value
}

func (v *NullableVideoCommentsForXMLInner) Set(val *VideoCommentsForXMLInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoCommentsForXMLInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoCommentsForXMLInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoCommentsForXMLInner(val *VideoCommentsForXMLInner) *NullableVideoCommentsForXMLInner {
	return &NullableVideoCommentsForXMLInner{value: val, isSet: true}
}

func (v NullableVideoCommentsForXMLInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoCommentsForXMLInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
