...
// checks if the CategoryOverview type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CategoryOverview{}

// CategoryOverview struct for CategoryOverview
...
func (o CategoryOverview) MarshalJSON() ([]byte, error) {
...
func (o CategoryOverview) ToMap() (map[string]interface{}, error) {
...
type NullableCategoryOverview struct {
	value *CategoryOverview
	isSet bool
}

func (v NullableCategoryOverview) Get() *CategoryOverview {
	return v.value
}

func (v *NullableCategoryOverview) Set(val *CategoryOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryOverview(val *CategoryOverview) *NullableCategoryOverview {
	return &NullableCategoryOverview{value: val, isSet: true}
}

func (v NullableCategoryOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
