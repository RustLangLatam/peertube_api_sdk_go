...
// checks if the ServerConfigCustomUser type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ServerConfigCustomUser{}

// ServerConfigCustomUser Settings that apply to new users, if registration is enabled
type ServerConfigCustomUser struct {
...
func (o ServerConfigCustomUser) MarshalJSON() ([]byte, error) {
...
func (o ServerConfigCustomUser) ToMap() (map[string]interface{}, error) {
...
type NullableServerConfigCustomUser struct {
	value *ServerConfigCustomUser
	isSet bool
}

func (v NullableServerConfigCustomUser) Get() *ServerConfigCustomUser {
	return v.value
}

func (v *NullableServerConfigCustomUser) Set(val *ServerConfigCustomUser) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigCustomUser) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigCustomUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigCustomUser(val *ServerConfigCustomUser) *NullableServerConfigCustomUser {
	return &NullableServerConfigCustomUser{value: val, isSet: true}
}

func (v NullableServerConfigCustomUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigCustomUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
