...
var _ utils.MappedNullable = &MRSSGroupContent{}
...
func (o *MRSSGroupContent) GetFileSize() int32 {
	if o == nil || utils.IsNil(o.FileSize) {
		var ret int32
		return ret
	}
	return *o.FileSize
...
func (o *MRSSGroupContent) GetFramerate() int32 {
	if o == nil || utils.IsNil(o.Framerate) {
		var ret int32
		return ret
	}
	return *o.Framerate
...
func (o MRSSGroupContent) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.FileSize) {
		toSerialize["fileSize"] = o.FileSize
	}
	if !utils.IsNil(o.Type) {
		toSerialize["type"] = o.Type
	}
	if !utils.IsNil(o.Framerate) {
