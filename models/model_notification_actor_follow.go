...
// checks if the NotificationActorFollow type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &NotificationActorFollow{}

// NotificationActorFollow struct for NotificationActorFollow
type NotificationActorFollow struct {
	Id        *int32                            `json:"id,omitempty"`
	Follower  *ActorInfo                        `json:"follower,omitempty"`
	State     *string                           `json:"state,omitempty"`
	Following *NotificationActorFollowFollowing `json:"following,omitempty"`
}
...
// SetFollower gets a reference to the given ActorInfo and assigns it to the Follower field.
...
func (o *NotificationActorFollow) GetFollowing() NotificationActorFollowFollowing {
	if o == nil || utils.IsNil(o.Following) {
		var ret NotificationActorFollowFollowing
		return ret
	}
	return *o.Following
}
...
// SetFollowing gets a reference to the given NotificationActorFollowFollowing and assigns it to the Following field.
func (o *NotificationActorFollow) SetFollowing(v NotificationActorFollowFollowing) {
	o.Following = &v
}

func (o NotificationActorFollow) MarshalJSON() ([]byte, error) {
...
func (o NotificationActorFollow) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationActorFollow struct {
	value *NotificationActorFollow
	isSet bool
}

func (v NullableNotificationActorFollow) Get() *NotificationActorFollow {
	return v.value
}

func (v *NullableNotificationActorFollow) Set(val *NotificationActorFollow) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationActorFollow) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationActorFollow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationActorFollow(val *NotificationActorFollow) *NullableNotificationActorFollow {
	return &NullableNotificationActorFollow{value: val, isSet: true}
}

func (v NullableNotificationActorFollow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationActorFollow) UnmarshalJSON(src []byte) error {
	v.isSet = true
