...
var _ utils.MappedNullable = &Storyboard{}
...
func (o *Storyboard) GetStoryboardPath() string {
	if o == nil || utils.IsNil(o.StoryboardPath) {
		var ret string
		return ret
	}
...
func (o *Storyboard) GetTotalHeight() int32 {
	if o == nil || utils.IsNil(o.TotalHeight) {
		var ret int32
		return ret
	}
...
func (o *Storyboard) GetTotalWidth() int32 {
	if o == nil || utils.IsNil(o.TotalWidth) {
		var ret int32
		return ret
	}
	return *o.TotalWidth
...
func (o *Storyboard) GetSpriteHeight() int32 {
	if o == nil || utils.IsNil(o.SpriteHeight) {
		var ret int32
		return ret
	}
...
func (o *Storyboard) GetSpriteWidth() int32 {
	if o == nil || utils.IsNil(o.SpriteWidth) {
		var ret int32
		return ret
	}
...
func (o *Storyboard) GetSpriteDuration() int32 {
	if o == nil || utils.IsNil(o.SpriteDuration) {
		var ret int32
		return ret
	}
