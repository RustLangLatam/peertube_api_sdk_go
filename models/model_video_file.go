...
var _ utils.MappedNullable = &VideoFile{}
...
func (o *VideoFile) GetMagnetUri() string {
	if o == nil || utils.IsNil(o.MagnetUri) {
		var ret string
		return ret
	}
	return *o.MagnetUri
...
func (o *VideoFile) GetTorrentUrl() string {
	if o == nil || utils.IsNil(o.TorrentUrl) {
		var ret string
		return ret
	}
	return *o.TorrentUrl
...
func (o *VideoFile) GetTorrentDownloadUrl() string {
	if o == nil || utils.IsNil(o.TorrentDownloadUrl) {
		var ret string
		return ret
	}
...
func (o *VideoFile) GetFileDownloadUrl() string {
	if o == nil || utils.IsNil(o.FileDownloadUrl) {
		var ret string
		return ret
	}
...
func (o *VideoFile) GetMetadataUrl() string {
	if o == nil || utils.IsNil(o.MetadataUrl) {
		var ret string
		return ret
	}
...
func (o *VideoFile) GetHasAudio() bool {
	if o == nil || utils.IsNil(o.HasAudio) {
		var ret bool
		return ret
	}
	return *o.HasAudio
...
func (o *VideoFile) GetHasVideo() bool {
	if o == nil || utils.IsNil(o.HasVideo) {
		var ret bool
		return ret
	}
	return *o.HasVideo
...
func (o VideoFile) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.MetadataUrl) {
		toSerialize["metadataUrl"] = o.MetadataUrl
	}
	if !utils.IsNil(o.HasAudio) {
		toSerialize["hasAudio"] = o.HasAudio
	}
	if !utils.IsNil(o.HasVideo) {
