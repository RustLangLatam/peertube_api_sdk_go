...
// checks if the ServerConfigVideoCaptionFile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ServerConfigVideoCaptionFile{}

// ServerConfigVideoCaptionFile struct for ServerConfigVideoCaptionFile
type ServerConfigVideoCaptionFile struct {
...
func NewServerConfigVideoCaptionFile() *ServerConfigVideoCaptionFile {
	this := ServerConfigVideoCaptionFile{}
	return &this
}
...
func (o ServerConfigVideoCaptionFile) MarshalJSON() ([]byte, error) {
...
func (o ServerConfigVideoCaptionFile) ToMap() (map[string]interface{}, error) {
...
type NullableServerConfigVideoCaptionFile struct {
	value *ServerConfigVideoCaptionFile
	isSet bool
}

func (v NullableServerConfigVideoCaptionFile) Get() *ServerConfigVideoCaptionFile {
	return v.value
}

func (v *NullableServerConfigVideoCaptionFile) Set(val *ServerConfigVideoCaptionFile) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigVideoCaptionFile) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigVideoCaptionFile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigVideoCaptionFile(val *ServerConfigVideoCaptionFile) *NullableServerConfigVideoCaptionFile {
	return &NullableServerConfigVideoCaptionFile{value: val, isSet: true}
}

func (v NullableServerConfigVideoCaptionFile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigVideoCaptionFile) UnmarshalJSON(src []byte) error {
	v.isSet = true
