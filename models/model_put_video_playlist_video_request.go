...
// checks if the PutVideoPlaylistVideoRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PutVideoPlaylistVideoRequest{}

// PutVideoPlaylistVideoRequest struct for PutVideoPlaylistVideoRequest
...
func NewPutVideoPlaylistVideoRequest() *PutVideoPlaylistVideoRequest {
	this := PutVideoPlaylistVideoRequest{}
	return &this
}
...
func (o PutVideoPlaylistVideoRequest) MarshalJSON() ([]byte, error) {
...
func (o PutVideoPlaylistVideoRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutVideoPlaylistVideoRequest struct {
	value *PutVideoPlaylistVideoRequest
	isSet bool
}

func (v NullablePutVideoPlaylistVideoRequest) Get() *PutVideoPlaylistVideoRequest {
	return v.value
}

func (v *NullablePutVideoPlaylistVideoRequest) Set(val *PutVideoPlaylistVideoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutVideoPlaylistVideoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutVideoPlaylistVideoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutVideoPlaylistVideoRequest(val *PutVideoPlaylistVideoRequest) *NullablePutVideoPlaylistVideoRequest {
	return &NullablePutVideoPlaylistVideoRequest{value: val, isSet: true}
}

func (v NullablePutVideoPlaylistVideoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutVideoPlaylistVideoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
