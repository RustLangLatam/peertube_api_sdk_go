...
var _ utils.MappedNullable = &ServerConfigImport{}

// ServerConfigImport struct for ServerConfigImport
type ServerConfigImport struct {
	Videos                      *ServerConfigImportVideos `json:"videos,omitempty"`
	VideoChannelSynchronization *ServerConfigEmail        `json:"videoChannelSynchronization,omitempty"`
	Users                       *ServerConfigEmail        `json:"users,omitempty"`
}
...
// SetUsers gets a reference to the given ServerConfigEmail and assigns it to the Users field.
...
func (o ServerConfigImport) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.VideoChannelSynchronization) {
		toSerialize["videoChannelSynchronization"] = o.VideoChannelSynchronization
	}
