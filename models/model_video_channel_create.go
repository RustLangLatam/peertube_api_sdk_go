...
// checks if the VideoChannelCreate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoChannelCreate{}
...
func (o VideoChannelCreate) ToMap() (map[string]interface{}, error) {
...
func (o *VideoChannelCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varVideoChannelCreate := _VideoChannelCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVideoChannelCreate)

	if err != nil {
		return err
	}

	*o = VideoChannelCreate(varVideoChannelCreate)
