...
// checks if the TagOverview type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &TagOverview{}

// TagOverview struct for TagOverview
...
func (o TagOverview) MarshalJSON() ([]byte, error) {
...
func (o TagOverview) ToMap() (map[string]interface{}, error) {
...
type NullableTagOverview struct {
	value *TagOverview
	isSet bool
}

func (v NullableTagOverview) Get() *TagOverview {
	return v.value
}

func (v *NullableTagOverview) Set(val *TagOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableTagOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableTagOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagOverview(val *TagOverview) *NullableTagOverview {
	return &NullableTagOverview{value: val, isSet: true}
}

func (v NullableTagOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
