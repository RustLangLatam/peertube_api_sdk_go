...
// checks if the VODHLSTranscoding1 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VODHLSTranscoding1{}

// VODHLSTranscoding1 struct for VODHLSTranscoding1
type VODHLSTranscoding1 struct {
...
func (o VODHLSTranscoding1) MarshalJSON() ([]byte, error) {
...
func (o VODHLSTranscoding1) ToMap() (map[string]interface{}, error) {
...
type NullableVODHLSTranscoding1 struct {
	value *VODHLSTranscoding1
	isSet bool
}

func (v NullableVODHLSTranscoding1) Get() *VODHLSTranscoding1 {
	return v.value
}

func (v *NullableVODHLSTranscoding1) Set(val *VODHLSTranscoding1) {
	v.value = val
	v.isSet = true
}

func (v NullableVODHLSTranscoding1) IsSet() bool {
	return v.isSet
}

func (v *NullableVODHLSTranscoding1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVODHLSTranscoding1(val *VODHLSTranscoding1) *NullableVODHLSTranscoding1 {
	return &NullableVODHLSTranscoding1{value: val, isSet: true}
}

func (v NullableVODHLSTranscoding1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVODHLSTranscoding1) UnmarshalJSON(src []byte) error {
	v.isSet = true
