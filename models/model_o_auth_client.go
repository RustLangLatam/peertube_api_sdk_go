...
var _ utils.MappedNullable = &OAuthClient{}

// OAuthClient struct for OAuthClient
type OAuthClient struct {
	ClientId     *string `json:"client_id,omitempty" validate:"regexp=^[a-z0-9]$"`
	ClientSecret *string `json:"client_secret,omitempty" validate:"regexp=^[a-zA-Z0-9]$"`
}
