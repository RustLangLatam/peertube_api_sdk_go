...
var _ utils.MappedNullable = &UpdateMe{}
...
func (o *UpdateMe) GetDisplayNSFW() string {
	if o == nil || utils.IsNil(o.DisplayNSFW) {
		var ret string
		return ret
	}
...
func (o *UpdateMe) GetVideosHistoryEnabled() bool {
	if o == nil || utils.IsNil(o.VideosHistoryEnabled) {
		var ret bool
		return ret
	}
...
func (o *UpdateMe) GetVideoLanguages() []string {
	if o == nil || utils.IsNil(o.VideoLanguages) {
		var ret []string
		return ret
	}
...
func (o UpdateMe) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.VideosHistoryEnabled) {
		toSerialize["videosHistoryEnabled"] = o.VideosHistoryEnabled
	}
	if !utils.IsNil(o.VideoLanguages) {
