...
// checks if the ApiV1AbusesPostRequestVideo type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApiV1AbusesPostRequestVideo{}

// ApiV1AbusesPostRequestVideo struct for ApiV1AbusesPostRequestVideo
type ApiV1AbusesPostRequestVideo struct {
	// Video id to report
...
func NewApiV1AbusesPostRequestVideo() *ApiV1AbusesPostRequestVideo {
	this := ApiV1AbusesPostRequestVideo{}
	return &this
}
...
func (o ApiV1AbusesPostRequestVideo) MarshalJSON() ([]byte, error) {
...
func (o ApiV1AbusesPostRequestVideo) ToMap() (map[string]interface{}, error) {
...
type NullableApiV1AbusesPostRequestVideo struct {
	value *ApiV1AbusesPostRequestVideo
	isSet bool
}

func (v NullableApiV1AbusesPostRequestVideo) Get() *ApiV1AbusesPostRequestVideo {
	return v.value
}

func (v *NullableApiV1AbusesPostRequestVideo) Set(val *ApiV1AbusesPostRequestVideo) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1AbusesPostRequestVideo) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1AbusesPostRequestVideo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1AbusesPostRequestVideo(val *ApiV1AbusesPostRequestVideo) *NullableApiV1AbusesPostRequestVideo {
	return &NullableApiV1AbusesPostRequestVideo{value: val, isSet: true}
}

func (v NullableApiV1AbusesPostRequestVideo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1AbusesPostRequestVideo) UnmarshalJSON(src []byte) error {
	v.isSet = true
