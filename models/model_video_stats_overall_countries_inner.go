...
// checks if the VideoStatsOverallCountriesInner type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoStatsOverallCountriesInner{}

// VideoStatsOverallCountriesInner struct for VideoStatsOverallCountriesInner
type VideoStatsOverallCountriesInner struct {
	IsoCode *string  `json:"isoCode,omitempty"`
	Viewers *float32 `json:"viewers,omitempty"`
}
...
func NewVideoStatsOverallCountriesInner() *VideoStatsOverallCountriesInner {
	this := VideoStatsOverallCountriesInner{}
	return &this
}
...
func (o *VideoStatsOverallCountriesInner) GetIsoCode() string {
	if o == nil || utils.IsNil(o.IsoCode) {
		var ret string
		return ret
	}
	return *o.IsoCode
...
// SetViewers gets a reference to the given float32 and assigns it to the Viewers field.
func (o *VideoStatsOverallCountriesInner) SetViewers(v float32) {
	o.Viewers = &v
}

func (o VideoStatsOverallCountriesInner) MarshalJSON() ([]byte, error) {
...
func (o VideoStatsOverallCountriesInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.IsoCode) {
...
type NullableVideoStatsOverallCountriesInner struct {
	value *VideoStatsOverallCountriesInner
	isSet bool
}

func (v NullableVideoStatsOverallCountriesInner) Get() *VideoStatsOverallCountriesInner {
	return v.value
}

func (v *NullableVideoStatsOverallCountriesInner) Set(val *VideoStatsOverallCountriesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoStatsOverallCountriesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoStatsOverallCountriesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoStatsOverallCountriesInner(val *VideoStatsOverallCountriesInner) *NullableVideoStatsOverallCountriesInner {
	return &NullableVideoStatsOverallCountriesInner{value: val, isSet: true}
}

func (v NullableVideoStatsOverallCountriesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoStatsOverallCountriesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
