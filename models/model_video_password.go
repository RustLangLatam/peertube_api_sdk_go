...
// checks if the VideoPassword type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoPassword{}

// VideoPassword struct for VideoPassword
...
func (o VideoPassword) MarshalJSON() ([]byte, error) {
...
func (o VideoPassword) ToMap() (map[string]interface{}, error) {
...
type NullableVideoPassword struct {
	value *VideoPassword
	isSet bool
}

func (v NullableVideoPassword) Get() *VideoPassword {
	return v.value
}

func (v *NullableVideoPassword) Set(val *VideoPassword) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoPassword) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoPassword) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoPassword(val *VideoPassword) *NullableVideoPassword {
	return &NullableVideoPassword{value: val, isSet: true}
}

func (v NullableVideoPassword) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoPassword) UnmarshalJSON(src []byte) error {
	v.isSet = true
