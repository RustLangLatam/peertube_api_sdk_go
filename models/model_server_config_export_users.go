...
var _ utils.MappedNullable = &ServerConfigExportUsers{}
...
func (o *ServerConfigExportUsers) GetExportExpiration() float32 {
	if o == nil || utils.IsNil(o.ExportExpiration) {
		var ret float32
		return ret
	}
...
func (o *ServerConfigExportUsers) GetMaxUserVideoQuota() float32 {
	if o == nil || utils.IsNil(o.MaxUserVideoQuota) {
		var ret float32
		return ret
	}
...
func (o ServerConfigExportUsers) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.ExportExpiration) {
		toSerialize["exportExpiration"] = o.ExportExpiration
	}
	if !utils.IsNil(o.MaxUserVideoQuota) {
