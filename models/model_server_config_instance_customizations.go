...
// checks if the ServerConfigInstanceCustomizations type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ServerConfigInstanceCustomizations{}

// ServerConfigInstanceCustomizations struct for ServerConfigInstanceCustomizations
type ServerConfigInstanceCustomizations struct {
...
func NewServerConfigInstanceCustomizations() *ServerConfigInstanceCustomizations {
	this := ServerConfigInstanceCustomizations{}
	return &this
}
...
func (o *ServerConfigInstanceCustomizations) GetJavascript() string {
	if o == nil || utils.IsNil(o.Javascript) {
		var ret string
		return ret
	}
	return *o.Javascript
...
func (o ServerConfigInstanceCustomizations) MarshalJSON() ([]byte, error) {
...
func (o ServerConfigInstanceCustomizations) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.Javascript) {
		toSerialize["javascript"] = o.Javascript
	}
	if !utils.IsNil(o.Css) {
		toSerialize["css"] = o.Css
	}
	return toSerialize, nil
}

type NullableServerConfigInstanceCustomizations struct {
	value *ServerConfigInstanceCustomizations
	isSet bool
}

func (v NullableServerConfigInstanceCustomizations) Get() *ServerConfigInstanceCustomizations {
	return v.value
}

func (v *NullableServerConfigInstanceCustomizations) Set(val *ServerConfigInstanceCustomizations) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigInstanceCustomizations) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigInstanceCustomizations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigInstanceCustomizations(val *ServerConfigInstanceCustomizations) *NullableServerConfigInstanceCustomizations {
	return &NullableServerConfigInstanceCustomizations{value: val, isSet: true}
}

func (v NullableServerConfigInstanceCustomizations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigInstanceCustomizations) UnmarshalJSON(src []byte) error {
	v.isSet = true
