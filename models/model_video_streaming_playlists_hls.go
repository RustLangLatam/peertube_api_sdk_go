...
var _ utils.MappedNullable = &VideoStreamingPlaylistsHLS{}
...
func (o *VideoStreamingPlaylistsHLS) GetPlaylistUrl() string {
	if o == nil || utils.IsNil(o.PlaylistUrl) {
		var ret string
		return ret
	}
...
func (o *VideoStreamingPlaylistsHLS) GetSegmentsSha256Url() string {
	if o == nil || utils.IsNil(o.SegmentsSha256Url) {
		var ret string
		return ret
	}
...
func (o VideoStreamingPlaylistsHLS) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.PlaylistUrl) {
		toSerialize["playlistUrl"] = o.PlaylistUrl
	}
	if !utils.IsNil(o.SegmentsSha256Url) {
