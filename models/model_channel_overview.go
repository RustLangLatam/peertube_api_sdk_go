...
// checks if the ChannelOverview type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ChannelOverview{}

// ChannelOverview struct for ChannelOverview
...
func (o ChannelOverview) MarshalJSON() ([]byte, error) {
...
func (o ChannelOverview) ToMap() (map[string]interface{}, error) {
...
type NullableChannelOverview struct {
	value *ChannelOverview
	isSet bool
}

func (v NullableChannelOverview) Get() *ChannelOverview {
	return v.value
}

func (v *NullableChannelOverview) Set(val *ChannelOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableChannelOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableChannelOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChannelOverview(val *ChannelOverview) *NullableChannelOverview {
	return &NullableChannelOverview{value: val, isSet: true}
}

func (v NullableChannelOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChannelOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
