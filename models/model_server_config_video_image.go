...
// checks if the ServerConfigVideoImage type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ServerConfigVideoImage{}

// ServerConfigVideoImage struct for ServerConfigVideoImage
type ServerConfigVideoImage struct {
...
func (o ServerConfigVideoImage) MarshalJSON() ([]byte, error) {
...
func (o ServerConfigVideoImage) ToMap() (map[string]interface{}, error) {
...
type NullableServerConfigVideoImage struct {
	value *ServerConfigVideoImage
	isSet bool
}

func (v NullableServerConfigVideoImage) Get() *ServerConfigVideoImage {
	return v.value
}

func (v *NullableServerConfigVideoImage) Set(val *ServerConfigVideoImage) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigVideoImage) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigVideoImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigVideoImage(val *ServerConfigVideoImage) *NullableServerConfigVideoImage {
	return &NullableServerConfigVideoImage{value: val, isSet: true}
}

func (v NullableServerConfigVideoImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigVideoImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
