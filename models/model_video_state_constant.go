...
// checks if the VideoStateConstant type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoStateConstant{}

// VideoStateConstant struct for VideoStateConstant
type VideoStateConstant struct {
...
func (o VideoStateConstant) MarshalJSON() ([]byte, error) {
...
func (o VideoStateConstant) ToMap() (map[string]interface{}, error) {
...
type NullableVideoStateConstant struct {
	value *VideoStateConstant
	isSet bool
}

func (v NullableVideoStateConstant) Get() *VideoStateConstant {
	return v.value
}

func (v *NullableVideoStateConstant) Set(val *VideoStateConstant) {
	v.value = val
	v.isSet = true
}

func (v NullableVideoStateConstant) IsSet() bool {
	return v.isSet
}

func (v *NullableVideoStateConstant) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVideoStateConstant(val *VideoStateConstant) *NullableVideoStateConstant {
	return &NullableVideoStateConstant{value: val, isSet: true}
}

func (v NullableVideoStateConstant) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoStateConstant) UnmarshalJSON(src []byte) error {
	v.isSet = true
