...
var _ utils.MappedNullable = &VideoComment{}
...
type VideoComment struct {
	...
	DeletedAt                   utils.NullableTime  `json:"deletedAt,omitempty"`
...
func (o *VideoComment) GetDeletedAt() time.Time {
	if o == nil || utils.IsNil(o.DeletedAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *VideoComment) GetIsDeleted() bool {
	if o == nil || utils.IsNil(o.IsDeleted) {
		var ret bool
		return ret
	}
	return *o.IsDeleted
...
func (o *VideoComment) GetTotalRepliesFromVideoAuthor() int32 {
	if o == nil || utils.IsNil(o.TotalRepliesFromVideoAuthor) {
		var ret int32
		return ret
	}
...
func (o *VideoComment) GetTotalReplies() int32 {
	if o == nil || utils.IsNil(o.TotalReplies) {
		var ret int32
		return ret
	}
