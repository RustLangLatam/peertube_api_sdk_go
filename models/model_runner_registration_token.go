...
// checks if the RunnerRegistrationToken type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RunnerRegistrationToken{}

// RunnerRegistrationToken struct for RunnerRegistrationToken
type RunnerRegistrationToken struct {
	Id                     *int32     `json:"id,omitempty"`
	RegistrationToken      *string    `json:"registrationToken,omitempty"`
	CreatedAt              *time.Time `json:"createdAt,omitempty"`
	UpdatedAt              *time.Time `json:"updatedAt,omitempty"`
	RegisteredRunnersCount *int32     `json:"registeredRunnersCount,omitempty"`
}
...
func (o *RunnerRegistrationToken) GetRegistrationToken() string {
	if o == nil || utils.IsNil(o.RegistrationToken) {
		var ret string
		return ret
	}
...
// GetRegisteredRunnersCount returns the RegisteredRunnersCount field value if set, zero value otherwise.
func (o *RunnerRegistrationToken) GetRegisteredRunnersCount() int32 {
	if o == nil || utils.IsNil(o.RegisteredRunnersCount) {
		var ret int32
		return ret
	}
	return *o.RegisteredRunnersCount
}

// GetRegisteredRunnersCountOk returns a tuple with the RegisteredRunnersCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunnerRegistrationToken) GetRegisteredRunnersCountOk() (*int32, bool) {
	if o == nil || utils.IsNil(o.RegisteredRunnersCount) {
		return nil, false
	}
	return o.RegisteredRunnersCount, true
}
...
// SetRegisteredRunnersCount gets a reference to the given int32 and assigns it to the RegisteredRunnersCount field.
func (o *RunnerRegistrationToken) SetRegisteredRunnersCount(v int32) {
	o.RegisteredRunnersCount = &v
}

func (o RunnerRegistrationToken) MarshalJSON() ([]byte, error) {
...
func (o RunnerRegistrationToken) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
	if !utils.IsNil(o.RegistrationToken) {
	...
	if !utils.IsNil(o.RegisteredRunnersCount) {
		toSerialize["registeredRunnersCount"] = o.RegisteredRunnersCount
	}
	return toSerialize, nil
}

type NullableRunnerRegistrationToken struct {
	value *RunnerRegistrationToken
	isSet bool
}

func (v NullableRunnerRegistrationToken) Get() *RunnerRegistrationToken {
	return v.value
}

func (v *NullableRunnerRegistrationToken) Set(val *RunnerRegistrationToken) {
	v.value = val
	v.isSet = true
}

func (v NullableRunnerRegistrationToken) IsSet() bool {
	return v.isSet
}

func (v *NullableRunnerRegistrationToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunnerRegistrationToken(val *RunnerRegistrationToken) *NullableRunnerRegistrationToken {
	return &NullableRunnerRegistrationToken{value: val, isSet: true}
}

func (v NullableRunnerRegistrationToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunnerRegistrationToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
