...
var _ utils.MappedNullable = &ServerConfigInstanceSocial{}
...
func (o *ServerConfigInstanceSocial) GetExternalLink() string {
	if o == nil || utils.IsNil(o.ExternalLink) {
		var ret string
		return ret
	}
...
func (o *ServerConfigInstanceSocial) GetMastodonLink() string {
	if o == nil || utils.IsNil(o.MastodonLink) {
		var ret string
		return ret
	}
...
func (o *ServerConfigInstanceSocial) GetBlueskyLink() string {
	if o == nil || utils.IsNil(o.BlueskyLink) {
		var ret string
		return ret
	}
...
func (o ServerConfigInstanceSocial) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.ExternalLink) {
		toSerialize["externalLink"] = o.ExternalLink
	}
	if !utils.IsNil(o.MastodonLink) {
		toSerialize["mastodonLink"] = o.MastodonLink
	}
	if !utils.IsNil(o.BlueskyLink) {
