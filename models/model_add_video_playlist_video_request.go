...
// checks if the AddVideoPlaylistVideoRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AddVideoPlaylistVideoRequest{}

// AddVideoPlaylistVideoRequest struct for AddVideoPlaylistVideoRequest
type AddVideoPlaylistVideoRequest struct {
	VideoId AddVideoPlaylistVideoRequestVideoId `json:"videoId"`
...
type _AddVideoPlaylistVideoRequest AddVideoPlaylistVideoRequest
...
func NewAddVideoPlaylistVideoRequest(videoId AddVideoPlaylistVideoRequestVideoId) *AddVideoPlaylistVideoRequest {
	this := AddVideoPlaylistVideoRequest{}
...
func (o *AddVideoPlaylistVideoRequest) GetVideoId() AddVideoPlaylistVideoRequestVideoId {
	if o == nil {
		var ret AddVideoPlaylistVideoRequestVideoId
		return ret
	}
...
func (o *AddVideoPlaylistVideoRequest) GetStartTimestamp() int32 {
	if o == nil || utils.IsNil(o.StartTimestamp) {
		var ret int32
		return ret
	}
...
func (o *AddVideoPlaylistVideoRequest) GetStopTimestamp() int32 {
	if o == nil || utils.IsNil(o.StopTimestamp) {
		var ret int32
		return ret
	}
...
func (o AddVideoPlaylistVideoRequest) MarshalJSON() ([]byte, error) {
...
func (o AddVideoPlaylistVideoRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["videoId"] = o.VideoId
	if !utils.IsNil(o.StartTimestamp) {
		toSerialize["startTimestamp"] = o.StartTimestamp
	}
	if !utils.IsNil(o.StopTimestamp) {
		toSerialize["stopTimestamp"] = o.StopTimestamp
	}
	return toSerialize, nil
}

func (o *AddVideoPlaylistVideoRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAddVideoPlaylistVideoRequest := _AddVideoPlaylistVideoRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddVideoPlaylistVideoRequest)

	if err != nil {
		return err
	}

	*o = AddVideoPlaylistVideoRequest(varAddVideoPlaylistVideoRequest)

	return err
}

type NullableAddVideoPlaylistVideoRequest struct {
	value *AddVideoPlaylistVideoRequest
	isSet bool
}

func (v NullableAddVideoPlaylistVideoRequest) Get() *AddVideoPlaylistVideoRequest {
	return v.value
}

func (v *NullableAddVideoPlaylistVideoRequest) Set(val *AddVideoPlaylistVideoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddVideoPlaylistVideoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddVideoPlaylistVideoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddVideoPlaylistVideoRequest(val *AddVideoPlaylistVideoRequest) *NullableAddVideoPlaylistVideoRequest {
	return &NullableAddVideoPlaylistVideoRequest{value: val, isSet: true}
}

func (v NullableAddVideoPlaylistVideoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddVideoPlaylistVideoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
