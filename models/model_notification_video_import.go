...
var _ utils.MappedNullable = &NotificationVideoImport{}

// NotificationVideoImport struct for NotificationVideoImport
type NotificationVideoImport struct {
	Id          *int32               `json:"id,omitempty"`
	Video       *VideoInfo           `json:"video,omitempty"`
	TorrentName utils.NullableString `json:"torrentName,omitempty"`
	...
	TargetUri utils.NullableString `json:"targetUri,omitempty"`
}
...
func (o *NotificationVideoImport) GetTorrentName() string {
	if o == nil || utils.IsNil(o.TorrentName.Get()) {
		var ret string
		return ret
	}
...
func (o *NotificationVideoImport) GetTargetUri() string {
	if o == nil || utils.IsNil(o.TargetUri.Get()) {
		var ret string
		return ret
	}
