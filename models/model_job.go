...
var _ utils.MappedNullable = &Job{}
...
func (o *Job) GetFinishedOn() time.Time {
	if o == nil || utils.IsNil(o.FinishedOn) {
		var ret time.Time
		return ret
	}
	return *o.FinishedOn
...
func (o *Job) GetProcessedOn() time.Time {
	if o == nil || utils.IsNil(o.ProcessedOn) {
		var ret time.Time
		return ret
	}
...
func (o Job) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.FinishedOn) {
		toSerialize["finishedOn"] = o.FinishedOn
	}
	if !utils.IsNil(o.ProcessedOn) {
