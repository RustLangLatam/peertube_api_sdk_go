...
// checks if the ActorImage type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ActorImage{}

// ActorImage struct for ActorImage
...
func (o ActorImage) MarshalJSON() ([]byte, error) {
...
func (o ActorImage) ToMap() (map[string]interface{}, error) {
...
type NullableActorImage struct {
	value *ActorImage
	isSet bool
}

func (v NullableActorImage) Get() *ActorImage {
	return v.value
}

func (v *NullableActorImage) Set(val *ActorImage) {
	v.value = val
	v.isSet = true
}

func (v NullableActorImage) IsSet() bool {
	return v.isSet
}

func (v *NullableActorImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorImage(val *ActorImage) *NullableActorImage {
	return &NullableActorImage{value: val, isSet: true}
}

func (v NullableActorImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
