...
var _ utils.MappedNullable = &VideoImport{}
...
func (o *VideoImport) GetTargetUrl() string {
	if o == nil || utils.IsNil(o.TargetUrl) {
		var ret string
		return ret
	}
	return *o.TargetUrl
...
func (o *VideoImport) GetTorrentfile() *os.File {
	if o == nil || utils.IsNil(o.Torrentfile) {
		var ret *os.File
		return ret
	}
...
func (o *VideoImport) GetTorrentName() string {
	if o == nil || utils.IsNil(o.TorrentName) {
		var ret string
		return ret
	}
