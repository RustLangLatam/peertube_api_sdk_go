...
// checks if the ServerConfigUser type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ServerConfigUser{}

// ServerConfigUser struct for ServerConfigUser
...
func (o ServerConfigUser) MarshalJSON() ([]byte, error) {
...
func (o ServerConfigUser) ToMap() (map[string]interface{}, error) {
...
type NullableServerConfigUser struct {
	value *ServerConfigUser
	isSet bool
}

func (v NullableServerConfigUser) Get() *ServerConfigUser {
	return v.value
}

func (v *NullableServerConfigUser) Set(val *ServerConfigUser) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigUser) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigUser(val *ServerConfigUser) *NullableServerConfigUser {
	return &NullableServerConfigUser{value: val, isSet: true}
}

func (v NullableServerConfigUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
