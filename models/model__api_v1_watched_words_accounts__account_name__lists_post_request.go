...
// checks if the ApiV1WatchedWordsAccountsAccountNameListsPostRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ApiV1WatchedWordsAccountsAccountNameListsPostRequest{}

// ApiV1WatchedWordsAccountsAccountNameListsPostRequest struct for ApiV1WatchedWordsAccountsAccountNameListsPostRequest
type ApiV1WatchedWordsAccountsAccountNameListsPostRequest struct {
...
func NewApiV1WatchedWordsAccountsAccountNameListsPostRequest() *ApiV1WatchedWordsAccountsAccountNameListsPostRequest {
	this := ApiV1WatchedWordsAccountsAccountNameListsPostRequest{}
	return &this
}
...
func (o ApiV1WatchedWordsAccountsAccountNameListsPostRequest) MarshalJSON() ([]byte, error) {
...
func (o ApiV1WatchedWordsAccountsAccountNameListsPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest struct {
	value *ApiV1WatchedWordsAccountsAccountNameListsPostRequest
	isSet bool
}

func (v NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) Get() *ApiV1WatchedWordsAccountsAccountNameListsPostRequest {
	return v.value
}

func (v *NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) Set(val *ApiV1WatchedWordsAccountsAccountNameListsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1WatchedWordsAccountsAccountNameListsPostRequest(val *ApiV1WatchedWordsAccountsAccountNameListsPostRequest) *NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest {
	return &NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest{value: val, isSet: true}
}

func (v NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1WatchedWordsAccountsAccountNameListsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
