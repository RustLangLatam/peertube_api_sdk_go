...
var _ utils.MappedNullable = &Plugin{}
...
func (o *Plugin) GetLatestVersion() string {
	if o == nil || utils.IsNil(o.LatestVersion) {
		var ret string
		return ret
	}
...
func (o *Plugin) GetUninstalled() bool {
	if o == nil || utils.IsNil(o.Uninstalled) {
		var ret bool
		return ret
	}
...
func (o *Plugin) GetPeertubeEngine() string {
	if o == nil || utils.IsNil(o.PeertubeEngine) {
		var ret string
		return ret
	}
...
func (o Plugin) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.LatestVersion) {
	...
	if !utils.IsNil(o.Uninstalled) {
		toSerialize["uninstalled"] = o.Uninstalled
	}
	if !utils.IsNil(o.PeertubeEngine) {
