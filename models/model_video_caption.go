...
// checks if the VideoCaption type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &VideoCaption{}

// VideoCaption struct for VideoCaption
type VideoCaption struct {
	Language    *VideoConstantStringLanguage `json:"language,omitempty"`
	CaptionPath *string                      `json:"captionPath,omitempty"`
}
...
// GetCaptionPath returns the CaptionPath field value if set, zero value otherwise.
func (o *VideoCaption) GetCaptionPath() string {
	if o == nil || utils.IsNil(o.CaptionPath) {
		var ret string
		return ret
	}
	return *o.CaptionPath
}

// GetCaptionPathOk returns a tuple with the CaptionPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VideoCaption) GetCaptionPathOk() (*string, bool) {
	if o == nil || utils.IsNil(o.CaptionPath) {
		return nil, false
	}
	return o.CaptionPath, true
}
...
// SetCaptionPath gets a reference to the given string and assigns it to the CaptionPath field.
func (o *VideoCaption) SetCaptionPath(v string) {
	o.CaptionPath = &v
}

func (o VideoCaption) MarshalJSON() ([]byte, error) {
...
func (o VideoCaption) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.Language) {
		toSerialize["language"] = o.Language
	}
	if !utils.IsNil(o.CaptionPath) {
		toSerialize["captionPath"] = o.CaptionPath
	}
...
func (v NullableVideoCaption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVideoCaption) UnmarshalJSON(src []byte) error {
	v.isSet = true
