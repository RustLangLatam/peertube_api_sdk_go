...
// checks if the VODHLSTranscoding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VODHLSTranscoding{}

// VODHLSTranscoding struct for VODHLSTranscoding
type VODHLSTranscoding struct {
...
func (o *VODHLSTranscoding) GetResolutionPlaylistFile() *os.File {
	if o == nil || IsNil(o.ResolutionPlaylistFile) {
		var ret *os.File
		return ret
	}
...
func (o VODHLSTranscoding) MarshalJSON() ([]byte, error) {
...
func (o VODHLSTranscoding) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VideoFile) {
		toSerialize["videoFile"] = o.VideoFile
	}
	if !IsNil(o.ResolutionPlaylistFile) {
		toSerialize["resolutionPlaylistFile"] = o.ResolutionPlaylistFile
	}
	return toSerialize, nil
}

type NullableVODHLSTranscoding struct {
	value *VODHLSTranscoding
	isSet bool
}

func (v NullableVODHLSTranscoding) Get() *VODHLSTranscoding {
	return v.value
}

func (v *NullableVODHLSTranscoding) Set(val *VODHLSTranscoding) {
	v.value = val
	v.isSet = true
}

func (v NullableVODHLSTranscoding) IsSet() bool {
	return v.isSet
}

func (v *NullableVODHLSTranscoding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVODHLSTranscoding(val *VODHLSTranscoding) *NullableVODHLSTranscoding {
	return &NullableVODHLSTranscoding{value: val, isSet: true}
}

func (v NullableVODHLSTranscoding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVODHLSTranscoding) UnmarshalJSON(src []byte) error {
	v.isSet = true
