...
//
//	@return OAuthClient
func (a *SessionAPIService) GetOAuthClientExecute(r ApiGetOAuthClientRequest) (*OAuthClient, *http.Response, error) {
	var (
...
func (r ApiGetOAuthTokenRequest) Execute() (*GetOAuthToken200Response, *http.Response, error) {
...
func (a *SessionAPIService) GetOAuthTokenExecute(r ApiGetOAuthTokenRequest) (*GetOAuthToken200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetOAuthToken200Response
	)
