...
var _ MappedNullable = &LiveVideoResponse{}
...
func (o *LiveVideoResponse) GetReplaySettings() LiveVideoReplaySettings {
	if o == nil || IsNil(o.ReplaySettings) {
...
func (o *LiveVideoResponse) GetPermanentLive() bool {
	if o == nil || IsNil(o.PermanentLive) {
		var ret bool
		return ret
	}
