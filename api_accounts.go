...
func (r ApiApiV1AccountsNameRatingsGetRequest) Execute() ([]VideoRating, *http.Response, error) {
...
//
//	@return []VideoRating
func (a *AccountsAPIService) ApiV1AccountsNameRatingsGetExecute(r ApiApiV1AccountsNameRatingsGetRequest) ([]VideoRating, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []VideoRating
	)
...
func (r ApiApiV1AccountsNameVideoChannelSyncsGetRequest) Execute() (*VideoChannelSyncList, *http.Response, error) {
...
func (a *AccountsAPIService) ApiV1AccountsNameVideoChannelSyncsGetExecute(r ApiApiV1AccountsNameVideoChannelSyncsGetRequest) (*VideoChannelSyncList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *VideoChannelSyncList
	)
...
func (r ApiApiV1AccountsNameVideoChannelsGetRequest) Execute() (*VideoChannelList, *http.Response, error) {
...
func (a *AccountsAPIService) ApiV1AccountsNameVideoChannelsGetExecute(r ApiApiV1AccountsNameVideoChannelsGetRequest) (*VideoChannelList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiApiV1AccountsNameVideoPlaylistsGetRequest) PlaylistType(playlistType VideoPlaylistTypeSet) ApiApiV1AccountsNameVideoPlaylistsGetRequest {
	r.playlistType = &playlistType
	return r
}

func (r ApiApiV1AccountsNameVideoPlaylistsGetRequest) Execute() (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
...
func (a *AccountsAPIService) ApiV1AccountsNameVideoPlaylistsGetExecute(r ApiApiV1AccountsNameVideoPlaylistsGetRequest) (*ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetAccountFollowersRequest) Execute() (*GetAccountFollowers200Response, *http.Response, error) {
...
func (a *AccountsAPIService) GetAccountFollowersExecute(r ApiGetAccountFollowersRequest) (*GetAccountFollowers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetAccountVideosRequest) CategoryOneOf(categoryOneOf GetAccountVideosCategoryOneOfParameter) ApiGetAccountVideosRequest {
...
// tag(s) of the video
func (r ApiGetAccountVideosRequest) TagsOneOf(tagsOneOf GetAccountVideosTagsOneOfParameter) ApiGetAccountVideosRequest {
	r.tagsOneOf = &tagsOneOf
	return r
}

// tag(s) of the video, where all should be present in the video
func (r ApiGetAccountVideosRequest) TagsAllOf(tagsAllOf GetAccountVideosTagsAllOfParameter) ApiGetAccountVideosRequest {
	r.tagsAllOf = &tagsAllOf
	return r
}

// licence id of the video (see [/videos/licences](#operation/getLicences))
func (r ApiGetAccountVideosRequest) LicenceOneOf(licenceOneOf GetAccountVideosLicenceOneOfParameter) ApiGetAccountVideosRequest {
...
func (r ApiGetAccountVideosRequest) LanguageOneOf(languageOneOf GetAccountVideosLanguageOneOfParameter) ApiGetAccountVideosRequest {
...
func (r ApiGetAccountVideosRequest) AutoTagOneOf(autoTagOneOf GetAccountVideosTagsAllOfParameter) ApiGetAccountVideosRequest {
...
func (r ApiGetAccountVideosRequest) PrivacyOneOf(privacyOneOf VideoPrivacySet) ApiGetAccountVideosRequest {
...
func (r ApiGetAccountVideosRequest) Execute() (*VideoListResponse, *http.Response, error) {
...
func (a *AccountsAPIService) GetAccountVideosExecute(r ApiGetAccountVideosRequest) (*VideoListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
