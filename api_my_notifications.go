...
type ApiApiV1UsersMeNotificationSettingsPutRequest struct {
	...
	apiV1UsersMeNotificationSettingsPutRequest *ApiV1UsersMeNotificationSettingsPutRequest
}

func (r ApiApiV1UsersMeNotificationSettingsPutRequest) ApiV1UsersMeNotificationSettingsPutRequest(apiV1UsersMeNotificationSettingsPutRequest ApiV1UsersMeNotificationSettingsPutRequest) ApiApiV1UsersMeNotificationSettingsPutRequest {
...
func (r ApiApiV1UsersMeNotificationsGetRequest) Execute() (*NotificationListResponse, *http.Response, error) {
...
func (a *MyNotificationsAPIService) ApiV1UsersMeNotificationsGetExecute(r ApiApiV1UsersMeNotificationsGetRequest) (*NotificationListResponse, *http.Response, error) {
	var (
...
type ApiApiV1UsersMeNotificationsReadPostRequest struct {
	ctx                                      context.Context
	ApiService                               *MyNotificationsAPIService
	apiV1UsersMeNotificationsReadPostRequest *ApiV1UsersMeNotificationsReadPostRequest
}

func (r ApiApiV1UsersMeNotificationsReadPostRequest) ApiV1UsersMeNotificationsReadPostRequest(apiV1UsersMeNotificationsReadPostRequest ApiV1UsersMeNotificationsReadPostRequest) ApiApiV1UsersMeNotificationsReadPostRequest {
