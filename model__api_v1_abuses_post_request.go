...
// checks if the ApiV1AbusesPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiV1AbusesPostRequest{}

// ApiV1AbusesPostRequest struct for ApiV1AbusesPostRequest
type ApiV1AbusesPostRequest struct {
	...
	Video             *ApiV1AbusesPostRequestVideo   `json:"video,omitempty"`
	Comment           *ApiV1AbusesPostRequestComment `json:"comment,omitempty"`
	Account           *ApiV1AbusesPostRequestAccount `json:"account,omitempty"`
}

type _ApiV1AbusesPostRequest ApiV1AbusesPostRequest
...
func (o *ApiV1AbusesPostRequest) GetPredefinedReasons() []string {
	if o == nil || IsNil(o.PredefinedReasons) {
		var ret []string
		return ret
	}
...
func (o *ApiV1AbusesPostRequest) GetVideo() ApiV1AbusesPostRequestVideo {
	if o == nil || IsNil(o.Video) {
		var ret ApiV1AbusesPostRequestVideo
		return ret
	}
	return *o.Video
}
...
// SetVideo gets a reference to the given ApiV1AbusesPostRequestVideo and assigns it to the Video field.
...
func (o *ApiV1AbusesPostRequest) GetComment() ApiV1AbusesPostRequestComment {
	if o == nil || IsNil(o.Comment) {
		var ret ApiV1AbusesPostRequestComment
		return ret
	}
	return *o.Comment
}
...
// SetComment gets a reference to the given ApiV1AbusesPostRequestComment and assigns it to the Comment field.
...
func (o *ApiV1AbusesPostRequest) GetAccount() ApiV1AbusesPostRequestAccount {
	if o == nil || IsNil(o.Account) {
		var ret ApiV1AbusesPostRequestAccount
		return ret
	}
	return *o.Account
}
...
// SetAccount gets a reference to the given ApiV1AbusesPostRequestAccount and assigns it to the Account field.
func (o *ApiV1AbusesPostRequest) SetAccount(v ApiV1AbusesPostRequestAccount) {
	o.Account = &v
}

func (o ApiV1AbusesPostRequest) MarshalJSON() ([]byte, error) {
...
func (o ApiV1AbusesPostRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["reason"] = o.Reason
	if !IsNil(o.PredefinedReasons) {
...
func (o *ApiV1AbusesPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApiV1AbusesPostRequest := _ApiV1AbusesPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiV1AbusesPostRequest)

	if err != nil {
		return err
	}

	*o = ApiV1AbusesPostRequest(varApiV1AbusesPostRequest)

	return err
}

type NullableApiV1AbusesPostRequest struct {
	value *ApiV1AbusesPostRequest
	isSet bool
}

func (v NullableApiV1AbusesPostRequest) Get() *ApiV1AbusesPostRequest {
	return v.value
}

func (v *NullableApiV1AbusesPostRequest) Set(val *ApiV1AbusesPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV1AbusesPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV1AbusesPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV1AbusesPostRequest(val *ApiV1AbusesPostRequest) *NullableApiV1AbusesPostRequest {
	return &NullableApiV1AbusesPostRequest{value: val, isSet: true}
}

func (v NullableApiV1AbusesPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV1AbusesPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
